<%@ Page Title="Basic Elements" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Elements.aspx.cs" Inherits="BeyondAdmin.WebForms.Pages.Elements" %>
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-6 col-xs-12">
                    <div class="well with-header">
                        ...
                        <div class="labels-container">
                            ...
                            <span class="label label-sky">sky
                            </span>
                            <span class="label label-blueberry">blueberry
                            </span>
                            <span class="label label-yellow">yellow
                            </span>
                            <span class="label label-darkorange">darkorange
                            </span>
                            <span class="label label-magenta">magenta
                            </span>
                            <span class="label label-purple">purple
                            </span>
                            <span class="label label-maroon">maroon
                            </span>
                            <span class="label label-darkpink">darkpink
                            </span>
                            <span class="label label-pink">pink
                            </span>
                            <span class="label label-azure">azure
                            </span>
                            <span class="label label-orange">orange
                            </span>
                        </div>
                        <hr class="wide" />
                        <div class="Badges-container">
                            <h6>Badges</h6>
                            <span class="badge badge-default">1
                            </span>
                            ...
                            <span class="badge badge-danger">5
                            </span>
                            <span class="badge badge-warning">6
                            </span>
                            <span class="badge badge-sky">7
                            </span>
                            <span class="badge badge-blueberry">8
                            </span>
                            <span class="badge badge-yellow">9
                            </span>
                            <span class="badge badge-darkorange">0
                            </span>
                            <span class="badge badge-magenta">1
                            </span>
                            <span class="badge badge-purple">2
                            </span>
                            <span class="badge badge-maroon">3
                            </span>
                            <span class="badge badge-darkpink">4
                            </span>
                            <span class="badge badge-pink">5
                            </span>
                            <span class="badge badge-azure">6
                            </span>
                            <span class="badge badge-orange">7
                            </span>
                        </div>
                        <hr class="wide" />
                        <div class="Badges-container">
                            <h6>Square Badges</h6>
                            <span class="badge badge-default badge-square">1
                            </span>
                            <span class="badge badge-primary badge-square">2
                            </span>
                            <span class="badge badge-info badge-square">3
                            </span>
                            <span class="badge badge-success badge-square">4
                            </span>
                            <span class="badge badge-danger badge-square">5
                            </span>
                            <span class="badge badge-warning badge-square">6
                            </span>
                            <span class="badge badge-sky badge-square">7
                            </span>
                            <span class="badge badge-blueberry badge-square">8
                            </span>
                            <span class="badge badge-yellow badge-square">9
                            </span>
                            <span class="badge badge-darkorange badge-square">0
                            </span>
                            <span class="badge badge-magenta badge-square">1
                            </span>
                            <span class="badge badge-purple badge-square">2
                            </span>
                            <span class="badge badge-maroon badge-square">3
                            </span>
                            <span class="badge badge-darkpink badge-square">4
                            </span>
                            <span class="badge badge-pink badge-square">5
                            </span>
                            <span class="badge badge-azure badge-square">6
                            </span>
                            <span class="badge badge-orange badge-square">7
                            </span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-6 col-xs-12">
                    <div class="well with-header">
                        ...
                        <div class="labels-container">
                            <h6>Labels</h6>
                            <span class="label label-default graded">Default
                            </span>
                            <span class="label label-primary graded">Primary
                            </span>
                            <span class="label label-info graded">Info
                            </span>
                            <span class="label label-success graded">Success
                            </span>
                            <span class="label label-danger graded">Danger
                            </span>
                            <span class="label label-warning graded">Warning
                            </span>
                            <span class="label label-sky graded">sky
                            </span>
                            <span class="label label-blueberry graded">blueberry
                            </span>
                            <span class="label label-yellow graded">yellow
                            </span>
                            <span class="label label-darkorange graded">darkorange
                            </span>
                            <span class="label label-magenta graded">magenta
                            </span>
                            <span class="label label-purple graded">purple
                            </span>
                            <span class="label label-maroon graded">maroon
                            </span>
                            <span class="label label-darkpink graded">darkpink
                            </span>
                            <span class="label label-pink graded">pink
                            </span>
                            <span class="label label-azure graded">azure
                            </span>
                            <span class="label label-orange graded">orange
                            </span>
                        </div>
                        <hr class="wide" />
                        <div class="Badges-container">
                            <h6>Badges</h6>
                            <span class="badge badge-default graded">1
                            </span>
                            <span class="badge badge-primary graded">2
                            </span>
                            <span class="badge badge-info graded">3
                            </span>
                            <span class="badge badge-success graded">4
                            </span>
                            <span class="badge badge-danger graded">5
                            </span>
                            <span class="badge badge-warning graded">6
                            </span>
                            <span class="badge badge-sky graded">7
                            </span>
                            <span class="badge badge-blueberry graded">8
                            </span>
                            <span class="badge badge-yellow graded">9
                            </span>
                            <span class="badge badge-darkorange graded">0
                            </span>
                            <span class="badge badge-magenta graded">1
                            </span>
                            <span class="badge badge-purple graded">2
                            </span>
                            <span class="badge badge-maroon graded">3
                            </span>
                            <span class="badge badge-darkpink graded">4
                            </span>
                            <span class="badge badge-pink graded">5
                            </span>
                            <span class="badge badge-azure graded">6
                            </span>
                            <span class="badge badge-orange graded">7
                            </span>
                        </div>
                        <hr class="wide" />
                        <div class="Badges-container">
                            <h6>Square Badges</h6>
                            <span class="badge badge-default badge-square graded">1
                            </span>
                            <span class="badge badge-primary badge-square graded">2
                            </span>
                            <span class="badge badge-info badge-square graded">3
                            </span>
                            <span class="badge badge-success badge-square graded">4
                            </span>
                            <span class="badge badge-danger badge-square graded">5
                            </span>
                            <span class="badge badge-warning badge-square graded">6
                            </span>
                            <span class="badge badge-sky badge-square graded">7
                            </span>
                            <span class="badge badge-blueberry badge-square graded">8
                            </span>
                            <span class="badge badge-yellow badge-square graded">9
                            </span>
                            <span class="badge badge-darkorange badge-square graded">0
                            </span>
                            <span class="badge badge-magenta badge-square graded">1
                            </span>
                            <span class="badge badge-purple badge-square graded">2
                            </span>
                            <span class="badge badge-maroon badge-square graded">3
                            </span>
                            <span class="badge badge-darkpink badge-square graded">4
                            </span>
                            <span class="badge badge-pink badge-square graded">5
                            </span>
                            <span class="badge badge-azure badge-square graded">6
                            </span>
                            <span class="badge badge-orange badge-square graded">7
                            </span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="dropdown-container">
                            <div class="dropdown-preview">
                                <ul class="dropdown-menu dropdown-purple">
                                    <li>
                                        <a href="#" tabindex="-1">Notifications
                                                            <span class="label label-darkorange pull-right">2</span>
                                        </a>
                                    </li>

                                    <li>
                                        <a href="#" tabindex="-1">Emails
                    ...
                    <div class="well with-header">
                        ...
                        <div class="progress">
                            <div class="progress-bar progress-bar-success" style="width: 35%">
                                <span class="sr-only">35% Complete (success)
                                </span>
                            </div>
                    ...
                    <div class="well with-header">
                        ...
                        <div class="progress progress-xs progress-bordered">
                            <div class="progress-bar progress-bar-silver" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 20%">
                                <span class="sr-only">30% Complete (success)
                                </span>
                            </div>
                        </div>
